...
NSString * const downloadUrl2 = @"http://120.25.226.186:32812/resources/videos/minion_02.mp4";
NSString * const downloadUrl3 = @"http://118.187.35.34:8889/test.rmvb";
...
- (void)download:(NSString *)url progressLabel:(UILabel *)progressLabel progressView:(UIProgressView *)progressView button:(UIButton *)button
{
    [[HSDownloadManager sharedInstance] download:url progress:^(NSInteger receivedSize, NSInteger expectedSize, CGFloat progress) {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            NSLog(@"receivedSize %ld  (%.f)------expectedSize %ld (%.f)",receivedSize,receivedSize/1024.0/1024.0,expectedSize,expectedSize/1024.0/1024.0);
        });
